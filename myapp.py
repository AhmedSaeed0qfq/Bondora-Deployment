...
def InputData():
    selectL = st.sidebar.selectbox("Select language:",
                                   ["English", "Estonian", "Finnish", "German", "Russian", "Slovakian", "Spanish",
                                    "Other"])
    if (selectL == "English"):
        Language = 0
    elif (selectL == "Estonian"):
        Language = 1
    elif (selectL == "Finnish"):
        Language = 2
    elif (selectL == "German"):
        Language = 3
    elif (selectL == "Other"):
        Language = 4
    elif (selectL == "Russian"):
        Language = 5
    elif (selectL == "Slovakian"):
        Language = 6
    else:
        Language = 7
    ...
    if (selectCountry == "EE"):
        selectCountry = 0
    elif (selectCountry == "ES"):
        selectCountry = 1
    elif (selectCountry == "FI"):
        selectCountry = 2
    else:
        selectCountry = 3
